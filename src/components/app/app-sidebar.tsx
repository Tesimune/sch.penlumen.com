        ...
        <SidebarProvider>
            <div className='flex min-h-screen w-full bg-background'>
                ...
                <Sidebar className='border-r border-border'>
                    <SidebarHeader className='flex justify-start order-b border-border p-2 h-16'>
                    ...
                    <SidebarContent>
                        <SidebarGroup className='py-4 px-0'>
                            <SidebarGroupLabel
                                className='px-6 py-2 text-xs font-semibold text-muted-foreground uppercase tracking-wider'>
                                Main Menu
                            </SidebarGroupLabel>
                            <SidebarGroupContent>
                ...
                <div className='flex-1 flex flex-col w-full'>
                    <header
                        className='flex h-16 items-center justify-between gap-4 border-b border-border bg-card px-6'>
